...
public class VarStepOnlyZcSrTest extends BasicTest
{
	@ConditionalIgnore(condition = DymolaLicenseWin32.class)
	@Test
	public void testWithZcBdSrConstraints() throws IOException, NanoHTTPD.ResponseException {
		test("/varsteptest/config-varStepSize-zcsrOnly.json", 0, 5.1);
	}
