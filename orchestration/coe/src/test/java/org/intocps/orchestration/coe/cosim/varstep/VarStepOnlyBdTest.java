...
public class VarStepOnlyBdTest extends BasicTest
{
	@ConditionalIgnore(condition = DymolaLicenseWin32.class)
	@Test
	public void testWithOneBoundDifferenceConstraint() throws IOException, NanoHTTPD.ResponseException {
		test("/varsteptest/config-varStepSize-bdOnly.json", 0, 5.01);
	}
