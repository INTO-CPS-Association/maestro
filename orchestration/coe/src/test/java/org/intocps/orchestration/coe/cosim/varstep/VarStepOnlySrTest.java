...
public class VarStepOnlySrTest extends BasicTest
{
	@ConditionalIgnore(condition = DymolaLicenseWin32.class)
	@Test
	public void testWithOneSamplingRateConstraint() throws IOException, NanoHTTPD.ResponseException {
		test("/varsteptest/config-varStepSize-srOnly.json", 0, 15.01);
	}
