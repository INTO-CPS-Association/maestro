...
//	}
    ...
    public boolean run(String configurationData, String simulationData, File outputFile) throws IOException, NanoHTTPD.ResponseException {
        ...
        try {
            ...
            response = callHttpAny(RequestHandler,
                    "/simulate/" + sessionId, simulationData);
            ...
            if (NanoHTTPD.Response.Status.OK != response.getStatus()) {
                return handleSimulateError(simulateResponseData, response);
            }
    ...
    public boolean run(String configurationData, double startTime, double endTime,
        ...
        return this.run(configurationData, simulateMsgJson, outputFile);
    ...
    protected boolean handleSimulateError(String simulateResponseData,
