...
{
	CoeObject.GlobalState processExternalSignals(CoeObject.GlobalState newState);
	double getRequiredSyncTime();
	void configure(Map<ModelConnection.ModelInstance, CoeObject.FmiSimulationInstanceScalaWrapper> instances );
}
