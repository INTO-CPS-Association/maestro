...
public class ScalarDerivativeEstimator
{
	...
	private DerivativeEstimationAlgorithm algorithm;
	...
	public ScalarDerivativeEstimator(final Integer order)
	{
		...
		algorithm = order.equals(1) ? new FirstOrderDerivativeEstimationAlgorithm()
				: new SecondOrderDerivativeEstimationAlgorithm();
		this.order = order;
	}
