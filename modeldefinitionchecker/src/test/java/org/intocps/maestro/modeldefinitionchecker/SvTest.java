...
public class SvTest {
    ...
    public void basicTest() {
        Orch.SV_X_ sv = new Orch.SV_X_(new inputQuote(), new fixedQuote(), null, new Orch.Type(new RealQuote(), 2));

        Tuple res = Orch.Validate(sv);

        Assertions.assertFalse((Boolean) res.get(0), "Expected the SV value to be invalid: " + sv);
    }
    ...
    public void inputDiscreteAppTest() {
        ...
        Assertions.assertTrue((Boolean) res.get(0), "Expected the SV value to be valid: " + sv + ". " + res.get(1));
    }
