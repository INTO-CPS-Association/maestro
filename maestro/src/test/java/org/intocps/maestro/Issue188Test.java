...
public class Issue188Test {
    ...
    public void InterpretSpec() throws Exception {
        Main.argumentHandler(new String[]{"-i", Issue188Test.class.getClassLoader().getResource("188/spec.mabl").getPath()});
    }
    ...
    public void CreateAndInterpretNewSpec() throws Exception {
        ...
        Main.argumentHandler(new String[]{"-sg1", initializeJson, simulateJson, "-d", dumpPath});
    }
