...
public class InitializePluginTest {
    ...
    public InputStream createConfigJson() {
        String singlewatertank_20simfmu = Paths.get("src", "test", "resources", "singlewatertank-20sim.fmu").toFile().getAbsoluteFile().toURI().toString();
        String watertankcontroller_cfmu = Paths.get("src", "test", "resources", "watertankcontroller-c.fmu").toFile().getAbsoluteFile().toURI().toString();
