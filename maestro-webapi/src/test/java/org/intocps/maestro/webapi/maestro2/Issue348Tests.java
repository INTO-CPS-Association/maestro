...
public class Issue348Tests {
    ...
    public void fixedStepSimulationRelativeFMU() throws Exception {
        File initializePath = new File(Issue348Tests.class.getClassLoader().getResource("maestro2/188/initialize.json").getPath());
    ...
    public void fixedStepSimulationRelativeDirectoryFMU() throws Exception {
        ...
        File initializePath = new File(Issue348Tests.class.getClassLoader().getResource("maestro2/188/initializeRelativeDirectory.json").getPath());
        fixedStepSimulationParameterizedInitialize(initializePath);
    }


    public void fixedStepSimulationParameterizedInitialize(File initializePath) throws Exception {
        File simulatePath = new File(Issue348Tests.class.getClassLoader().getResource("maestro2/188/simulate.json").getPath());
