...
/*
    ...
    private BooleanVariableFmi2Api checkConvergence(Fmi2Builder.ProvidesTypedReferenceExp a, Fmi2Builder.ProvidesTypedReferenceExp b,
    ...
    public BooleanVariableFmi2Api checkConvergence(Fmi2Builder.ProvidesTypedReferenceExp a, Fmi2Builder.ProvidesTypedReferenceExp b,
        ...
        if (Stream.of(a, b, absoluteTolerance, relativeTolerance).allMatch(x -> x instanceof ARealNumericPrimitiveType)) {
            return this.checkConvergence(a, b, absoluteTolerance, relativeTolerance);
        } else {
