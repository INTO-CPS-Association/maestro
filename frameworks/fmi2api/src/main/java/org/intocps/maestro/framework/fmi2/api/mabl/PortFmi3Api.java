...
public class PortFmi3Api implements FmiBuilder.Port<Fmi3ModelDescription.Fmi3ScalarVariable> {
    ...
    @Override
    public void linkTo(FmiBuilder.Port<Fmi3ModelDescription.Fmi3ScalarVariable>... receivers) throws PortLinkException {
