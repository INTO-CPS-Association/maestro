...
public class IntVariableFmi2Api extends VariableFmi2Api<FmiBuilder.IntExpressionValue> implements FmiBuilder.IntVariable<PStm> {
    public IntVariableFmi2Api(PStm declaration, IMablScope declaredScope, FmiBuilder.DynamicActiveScope<PStm> dynamicScope,
    ...
    @Override
    public void setValue(FmiBuilder.IntExpressionValue addition) {
