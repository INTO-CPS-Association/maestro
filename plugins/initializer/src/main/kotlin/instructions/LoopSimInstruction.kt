...
class LoopSimInstruction(
    scope: FmiBuilder.Scope<*>,
    private val maxStepAcceptAttempts: FmiBuilder.IntVariable<PStm>,
    private val absoluteTolerance: FmiBuilder.DoubleVariable<PStm>,
    private val relativeTolerance: FmiBuilder.DoubleVariable<PStm>,
    ...
    private val math: MathBuilderFmi2Api
) : ComplexCoSimInstruction(simulationActions, scope) {
