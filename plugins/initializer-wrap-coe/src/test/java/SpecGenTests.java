...
public class SpecGenTests {
    ...
    @Test
    @Ignore("Ignored because the coe behaviour does not match the behaviour of initialize plugin")
    public void testWatertankExample() throws IOException, NanoHTTPD.ResponseException {
        ...
        //PStm stm = sg.run(knownComponentNames, configurationData, startMsg, startTime, endTime);
